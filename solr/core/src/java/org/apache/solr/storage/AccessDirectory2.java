...
public class AccessDirectory2 extends MMapDirectory {
  ...
  static final class LazyEntry {
    ...
    private final WeakReference<AccessDirectory2> dir;
    private final int[] from = new int[1];

    private LazyEntry(
        String canonicalName, String lazyName, LazyLoadInput input, AccessDirectory2 dir) {
    ...
    public int load() throws IOException {
      AccessDirectory2 dir = this.dir.get();
      if (dir == null) {
        return -1;
      }
