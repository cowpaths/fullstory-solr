...
class Cache3<V extends Cache3.Val> {
  ...
  static class Val {
     ...
     * atomically via {@link Cache3#NEXT_VH} and {@link Cache3#PREV_VH}. Sentinel slots (COLD_HEAD,
   ...
   */
  Cache3(int capacity, int extraSentinelSlots, Iterable<? extends V> initialValues) {
  ...
  static class TsVal extends Val {
    ...
    /**
     * Nanosecond timestamp of the most recent {@link Cache3#unpin}, or {@code 0} if never unpinned.
  ...
  static class DualQueueCache<V extends TsVal> extends Cache3<V> {
