...
public class TestFilterStats extends SolrTestCaseJ4 {
  ...
  public void testFiltersStatsAlwaysOn() throws Exception {
    ...
    assertJQ(
        ...
        "/responseHeader/filtersStats/[0]/key=='foo_s:a'",
        "/responseHeader/filtersStats/[0]/time==\"///ignore///\"",
        "/responseHeader/filtersStats/[0]/cacheHit==false",
        "/responseHeader/filtersStats/[0]/docSetIdCount==2",
        // using regex value below as the query class could be LegacyNumericRangeQuery,
        // IndexOrDocValuesQuery
        // or IntPoint$1, which give different toString values
        "/responseHeader/filtersStats/[1]/key==\"///regex:.*val_i:\\\\[1 TO 3\\\\].*///\"",
        "/responseHeader/filtersStats/[1]/time==\"///ignore///\"",
        "/responseHeader/filtersStats/[1]/cacheHit==false",
    ...
    assertJQ(
        ...
        "/responseHeader/filtersStats/[0]/key=='foo_s:a'",
        "/responseHeader/filtersStats/[0]/time==\"///ignore///\"",
        "/responseHeader/filtersStats/[0]/cacheHit==true",
        "/responseHeader/filtersStats/[0]/docSetIdCount==2",
        "/responseHeader/filtersStats/[1]/key==\"///regex:.*val_i:\\\\[1 TO 3\\\\].*///\"",
        "/responseHeader/filtersStats/[1]/time==\"///ignore///\"",
        "/responseHeader/filtersStats/[1]/cacheHit==true",
        "/responseHeader/filtersStats/[1]/docSetIdCount==3");
    ...
    assertJQ(
        ...
        "/responseHeader/filtersStats/[0]/cacheHit==true",
        "/responseHeader/filtersStats/[0]/docSetIdCount==2",
        "/responseHeader/filtersStats/[1]/key==\"///regex:.*val_i:\\\\[1 TO 2\\\\].*///\"",
        "/responseHeader/filtersStats/[1]/time==\"///ignore///\"",
        "/responseHeader/filtersStats/[1]/cacheHit==false",
