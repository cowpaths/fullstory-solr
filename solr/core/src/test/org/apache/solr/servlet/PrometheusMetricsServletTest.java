...
public class PrometheusMetricsServletTest {
  ...
  @Test
  public void testCollectionCacheMetricsApiCaller() throws Exception {
    String json =
        "{\n"
            + "  \"responseHeader\":{\n"
            + "    \"status\":0,\n"
            + "    \"QTime\":14},\n"
            + "  \"metrics\":{\n"
            + "   \"solr.core.o-221JN4-na1.shard3_1_1_0_1_0_1_1_1_1.replica_n6245\":{\n"
            ...
            + "        \"bytesUsed\":4016316,\n"
            + "        \"warmupTime\":0,\n"
            + "        \"cumulative_lookups\":11,\n"
            + "        \"cumulative_hits\":2,\n"
            + "        \"cumulative_hitratio\":0.18,\n"
            + "        \"cumulative_inserts\":9,\n"
            + "        \"cumulative_evictions\":2,\n"
            + "        \"cumulative_bytesUsed\":4016316,\n"
            + "        \"partialHits\":0,\n"
            + "        \"partialHitsRatio\":0.0,\n"
            + "        \"partialRatioPerHit\":1.0,\n"
            + "        \"cumulative_partialHits\":0,\n"
            + "        \"cumulative_partialHitsRatio\":0.0,\n"
            + "        \"cumulative_partialRatioPerHit\":1.0\n"
            + "      }\n"
            + "    },\n"
            + "    \"solr.core.o-221JN4-na1.shard3_1_1_0_1_0_1_1_0_1.replica_n7160\":{\n"
            + "      \"CACHE.searcher.filterCache\":{\n"
            + "        \"lookups\":9,\n"
            + "        \"hits\":2,\n"
            + "        \"hitratio\":0.22,\n"
            ...
            + "        \"bytesUsed\":3868232,\n"
            + "        \"warmupTime\":0,\n"
            + "        \"cumulative_lookups\":9,\n"
            + "        \"cumulative_hits\":2,\n"
            + "        \"cumulative_hitratio\":0.22,\n"
            + "        \"cumulative_inserts\":7,\n"
            + "        \"cumulative_evictions\":3,\n"
            + "        \"cumulative_bytesUsed\":3868232,\n"
            + "        \"partialHits\":0,\n"
            + "        \"partialHitsRatio\":0.0,\n"
            + "        \"partialRatioPerHit\":1.0,\n"
            + "        \"cumulative_partialHits\":0,\n"
            ...
            + "      }\n"
            + "    },\n"
            + "    \"solr.core.o2.shard1.replica_n7160\":{\n"
            + "      \"CACHE.searcher.filterCache\":{\n"
            + "        \"lookups\":9,\n"
            + "        \"hits\":2,\n"
            + "        \"hitratio\":0.22,\n"
            ...
            + "}";
    String output =
        "# HELP filter_cache_store_local_hits_by_collection Cumulative hits from local filter cache store (vs backing shared cache store)(collection o-221JN4-na1)\n"
            + "# TYPE filter_cache_store_local_hits_by_collection counter\n"
            + "filter_cache_store_local_hits_by_collection{collection=\"o-221JN4-na1\"} 4\n"
            + "# HELP filter_cache_store_local_lookups_by_collection Cumulative lookups from local filter cache store (vs backing shared cache store)(collection o-221JN4-na1)\n"
            + "# TYPE filter_cache_store_local_lookups_by_collection counter\n"
            + "filter_cache_store_local_lookups_by_collection{collection=\"o-221JN4-na1\"} 20\n"
            + "# HELP filter_cache_store_local_eviction_by_collection Cumulative evictions from local filter cache store (vs backing shared cache store)(collection o-221JN4-na1)\n"
            + "# TYPE filter_cache_store_local_eviction_by_collection counter\n"
            + "filter_cache_store_local_eviction_by_collection{collection=\"o-221JN4-na1\"} 5\n"
            + "# HELP filter_cache_store_local_hits_by_collection Cumulative hits from local filter cache store (vs backing shared cache store)(collection o2)\n"
            + "# TYPE filter_cache_store_local_hits_by_collection counter\n"
            + "filter_cache_store_local_hits_by_collection{collection=\"o2\"} 2\n"
            + "# HELP filter_cache_store_local_lookups_by_collection Cumulative lookups from local filter cache store (vs backing shared cache store)(collection o2)\n"
            + "# TYPE filter_cache_store_local_lookups_by_collection counter\n"
            + "filter_cache_store_local_lookups_by_collection{collection=\"o2\"} 9\n"
            + "# HELP filter_cache_store_local_eviction_by_collection Cumulative evictions from local filter cache store (vs backing shared cache store)(collection o2)\n"
            + "# TYPE filter_cache_store_local_eviction_by_collection counter\n"
            + "filter_cache_store_local_eviction_by_collection{collection=\"o2\"} 0\n";
    assertMetricsApiCaller(
        new PrometheusMetricsServlet.CollectionCacheMetricsApiCaller(), json, 14, output);
  }
}
