  ...
  public void testCoresMetricsApiCaller() throws Exception {
    String json =
        "{\n"
            ...
            + "      \"UPDATE.updateHandler.autoCommits.commitReason.MAX_SIZE\":{\"count\":3},\n"
            + "      \"UPDATE.updateHandler.autoCommits.commitReason.MAX_DOCS\":{\"count\":4},\n"
            + "      \"UPDATE.updateHandler.autoCommits.commitReason.COMMIT_WITHIN\":{\"count\":6},\n"
            ...
            + "      \"UPDATE.updateHandler.autoCommits.commitReason.MAX_SIZE\":{\"count\":10},\n"
            + "      \"UPDATE.updateHandler.autoCommits.commitReason.MAX_DOCS\":{\"count\":9},\n"
            + "      \"UPDATE.updateHandler.autoCommits.commitReason.COMMIT_WITHIN\":{\"count\":10},\n"
    ...
    String output =
        "# HELP merges_major cumulative number of major merges across cores\n"
            ...
            + "# HELP auto_commits_hard cumulative number of hard auto commits across cores\n"
            + "# TYPE auto_commits_hard counter\n"
            + "auto_commits_hard{commitReason=\"MAX_SIZE\"} 13\n"
            + "# HELP auto_commits_hard cumulative number of hard auto commits across cores\n"
            + "# TYPE auto_commits_hard counter\n"
            + "auto_commits_hard{commitReason=\"MAX_DOCS\"} 13\n"
            + "# HELP auto_commits_hard cumulative number of hard auto commits across cores\n"
            + "# TYPE auto_commits_hard counter\n"
            + "auto_commits_hard{commitReason=\"COMMIT_WITHIN\"} 16\n"
